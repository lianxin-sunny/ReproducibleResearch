...
Mean values didn't change, because here we supplied interval averge for the given interval, so total average didn't change. Histogram and median changed somewhat. Filling values added total of `r total_diff` steps.
...
data_with_weekdays$wk <- ifelse(data_with_weekdays$day %in% c("ÐÇÆÚÁù", "ÐÇÆÚÈÕ"),"weekend", "weekday") 
# ATTENTION: My laptop has a Chinese environment, so I use Chinese to split weekend and weekdays.
